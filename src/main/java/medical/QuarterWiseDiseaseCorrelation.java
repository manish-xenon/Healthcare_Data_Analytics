...
public class QuarterWiseDiseaseCorrelation {
    ...
    private static void plotGraph(String disease, Map<Integer, Map<Integer, Integer>> year_month_count_map,
        ...
        String title = "Plot of " + disease + " occurence per Quarter";
        ...
        File XYChart = new File("diseases_quarter_graph/" + disease + "_Stat.jpeg");
